...
from .storages.WrapperControllerStorage import WrapperControllerStorage
...
class StorageController:
    ...
    def create_wrapper_controller_storage(self) -> WrapperControllerStorage:
        return WrapperControllerStorage(self.__session)
